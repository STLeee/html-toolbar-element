declare global {
  interface Window {
    HTMLToolbarElement: typeof HTMLToolbarElement
    HTMLBoldButtonElement: typeof HTMLBoldButtonElement
    HTMLItalicButtonElement: typeof HTMLItalicButtonElement
    HTMLUnderlineButtonElement: typeof HTMLUnderlineButtonElement
    HTMLStrikethroughButtonElement: typeof HTMLStrikethroughButtonElement
    HTMLCodeButtonElement: typeof HTMLCodeButtonElement
    HTMLLinkButtonElement: typeof HTMLLinkButtonElement
  }
  interface HTMLElementTagNameMap {
    'html-toolbar': HTMLToolbarElement
    'html-bold': HTMLBoldButtonElement
    'html-italic': HTMLItalicButtonElement
    'html-underline': HTMLUnderlineButtonElement
    'html-strikethrough': HTMLStrikethroughButtonElement
    'html-code': HTMLCodeButtonElement
    'html-link': HTMLLinkButtonElement
  }
}
...
function getButtons(toolbar: Element): HTMLElement[] {
  ...
  for (const button of toolbar.querySelectorAll<HTMLElement>(buttonSelectors.join(', '))) {
    ...
    if (button.closest('html-toolbar') === toolbar) els.push(button)
  }
  return els
}
...
class HTMLBoldButtonElement extends HTMLButtonElement {
  constructor() {
    super()
    styles.set(this, {prefix: '<b>', suffix: '</b>', trimFirst: true})
  }
...
if (!window.customElements.get('html-bold')) {
  window.HTMLBoldButtonElement = HTMLBoldButtonElement
  window.customElements.define('html-bold', HTMLBoldButtonElement)
}

class HTMLItalicButtonElement extends HTMLButtonElement {
  constructor() {
    super()
    styles.set(this, {prefix: '<i>', suffix: '</i>', trimFirst: true})
  }
...
if (!window.customElements.get('html-italic')) {
  window.HTMLItalicButtonElement = HTMLItalicButtonElement
  window.customElements.define('html-italic', HTMLItalicButtonElement)
}

class HTMLUnderlineButtonElement extends HTMLButtonElement {
  constructor() {
    super()
    styles.set(this, {prefix: '<u>', suffix: '</u>', trimFirst: true})
  }
...
if (!window.customElements.get('html-underline')) {
  window.HTMLUnderlineButtonElement = HTMLUnderlineButtonElement
  window.customElements.define('html-underline', HTMLUnderlineButtonElement)
}

class HTMLStrikethroughButtonElement extends HTMLButtonElement {
  constructor() {
    super()
    styles.set(this, {prefix: '<s>', suffix: '</s>', trimFirst: true})
  }
...
if (!window.customElements.get('html-strikethrough')) {
  window.HTMLStrikethroughButtonElement = HTMLStrikethroughButtonElement
  window.customElements.define('html-strikethrough', HTMLStrikethroughButtonElement)
}

class HTMLCodeButtonElement extends HTMLButtonElement {
  constructor() {
    super()
    styles.set(this, {prefix: '<code>', suffix: '</code>', blockPrefix: '<pre>', blockSuffix: '</pre>'})
  }
}

if (!window.customElements.get('html-code')) {
  window.HTMLCodeButtonElement = HTMLCodeButtonElement
  window.customElements.define('html-code', HTMLCodeButtonElement)
}

class HTMLLinkButtonElement extends HTMLButtonElement {
  constructor() {
    super()
    styles.set(this, {prefix: '<a href="url">', suffix: '</a>', replaceNext: 'url', scanFor: 'https?://'})
  }
...
if (!window.customElements.get('html-link')) {
  window.HTMLLinkButtonElement = HTMLLinkButtonElement
  window.customElements.define('html-link', HTMLLinkButtonElement)
}

const modifierKey = navigator.userAgent.match(/Macintosh/) ? 'Meta' : 'Control'

class HTMLToolbarElement extends HTMLElement {
  constructor() {
    super()
  }
...
if (!window.customElements.get('html-toolbar')) {
  window.HTMLToolbarElement = HTMLToolbarElement
  window.customElements.define('html-toolbar', HTMLToolbarElement)
}
...
function applyStyle(button: Element, stylesToApply: Style) {
  const toolbar = button.closest('html-toolbar')
  if (!(toolbar instanceof HTMLToolbarElement)) return
...
export default HTMLToolbarElement
